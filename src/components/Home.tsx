...
const Home = () => {
    return (
        <>
            <div className="bg-[url('src/assets/bg.svg')] min-h-screen w-screen bg-no-repeat bg-cover flex items-center flex-col object-cover">
                <img src="src/assets/ISAP.svg" alt="logo" className="pt-12" width={164} height={78} />
